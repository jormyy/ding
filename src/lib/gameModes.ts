import type { CardMeta, Phase, Rank, Suit } from "./types";
...
export const GAME_MODE_DEFINITIONS: readonly DingGameModeDefinition[] = [
  ...
  },
  {
    ...
    name: "Card Counters",
    shortName: "Counters",
    summary: "The table sees how many deck cards remain.",
    detail: "Each broadcast includes a public remaining-deck count for cooperative deduction.",
  ...
  },
  {
    ...
    name: "Suit Census",
    shortName: "Suit C",
    summary: "The table sees remaining-deck suit counts.",
    detail: "Each broadcast includes public suit composition for the remaining deck.",
  ...
  },
  {
    ...
    name: "Rank Census",
    shortName: "Rank C",
    summary: "The table sees remaining-deck rank counts.",
    detail: "Each broadcast includes public rank composition for the remaining deck.",
  ...
  },
  {
    ...
    name: "Burn Reveal",
    shortName: "Burn",
    summary: "Burn cards are public information.",
    detail: "The initial deal records burn cards and exposes them through mode info.",
  ...
  },
  {
    ...
    name: "Hint Card",
    shortName: "Hint",
    summary: "At turn, one deck card is briefly shown.",
    detail: "The turn broadcast exposes the next deck card as a public hint without adding it to scoring.",
  ...
  },
  {
    ...
    name: "Decoy",
    shortName: "Decoy",
    summary: "A face-down decoy sits on the table and does not score.",
    detail: "The table receives a public decoy notice while showdown still uses the real five-card board.",
  ...
  },
  {
    ...
    name: "Lying Mirror",
    shortName: "Mirror",
    summary: "A fake flop is shown alongside the real one.",
    detail: "The flop broadcast includes a fake flop from the deck as public mode info; scoring still uses the real board.",
  ...
  },
  {
    ...
    name: "Whisper Chain",
    shortName: "Whisper",
    summary: "Each left neighbor knows one of your holes.",
    detail: "The accelerated pass exposes a cooperative whisper notice and one public hole hint per hand.",
  ...
  },
  {
    ...
    name: "Periscope",
    shortName: "Scope",
    summary: "At river, one opponent hole card can be seen.",
    detail: "A single hole-card hint becomes public at river, preserving cooperative symmetry.",
  ...
  },
  {
    ...
    name: "Mirror Hole",
    shortName: "Mirror H",
    summary: "You see neighbor-hole information instead of your own certainty.",
    detail: "The accelerated cooperative version exposes a public neighbor-mirror notice while hands stay otherwise private.",
  ...
  },
  {
    ...
    name: "Tag Team",
    shortName: "Tag",
    summary: "Neighbor hand knowledge becomes shared cooperative texture.",
    detail: "The accelerated cooperative version makes full hole information public across streets.",
    tags: ["visibility", "holes"],
    deal: { ...standardDeal, visibleHoleCards: { preflop: 2, flop: 2, turn: 2, river: 2, reveal: 2 } },
  ...
  },
  {
    ...
    name: "Sample Draw",
    shortName: "Sample",
    summary: "At river, three off-board deck samples are shown.",
    detail: "The river broadcast reveals three non-scoring deck cards as public table information.",
    tags: ["visibility", "deck"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Tell",
    shortName: "Tell",
    summary: "Each phase provides one true public fact.",
    detail: "The server publishes a deterministic true fact about the current deck or board each street.",
  ...
  },
  {
    ...
    name: "Suit Whisper",
    shortName: "S-Whisper",
    summary: "Players receive a true suit-absence hint.",
    detail: "The accelerated pass publishes a symmetric suit whisper derived from current private hands.",
    tags: ["visibility", "suits"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Rank Whisper",
    shortName: "R-Whisper",
    summary: "Players receive a true rank-absence hint.",
    detail: "The accelerated pass publishes a symmetric rank whisper derived from current private hands.",
    tags: ["visibility", "ranks"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Phantom Card",
    shortName: "Phantom",
    summary: "A rank not in the hand is announced.",
    detail: "A public phantom rank is generated from remaining deck state without changing scoring.",
    tags: ["visibility", "ranks"],
    deal: standardDeal,
  ...
  },
  {
    ...
    shortName: "Late Hand",
    summary: "All hole cards become public at river.",
    detail: "A catalogued late-reveal variant distinct from Late Light but using the same phase-aware visibility rule.",
    tags: ["visibility", "river"],
    deal: { ...standardDeal, visibleHoleCards: { river: 2, reveal: 2 } },
  ...
  },
  {
    ...
    name: "Earthquake",
    shortName: "Quake",
    summary: "At turn, the board reshuffles in place.",
    detail: "The same community cards stay in play, but their order is rotated when turn begins.",
    tags: ["event", "board"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Tornado",
    shortName: "Tornado",
    summary: "At turn, hole cards rotate one seat clockwise.",
    detail: "Each hand passes its hole-card contents to the next hand in table order when turn begins.",
    tags: ["event", "holes"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Lightning",
    shortName: "Lightning",
    summary: "At river, one card per hand jumps one rank.",
    detail: "The first hole card in each hand upgrades by one rank when river begins.",
    tags: ["event", "ranks"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Flood",
    shortName: "Flood",
    summary: "Cards 2-5 are wild after the flood hits.",
    detail: "Low ranks can substitute into the strongest reveal identity.",
    tags: ["event", "wild"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Drought",
    shortName: "Drought",
    summary: "At turn, face cards are removed from play.",
    detail: "Jacks, queens, and kings vanish from hands and board when turn begins.",
    tags: ["event", "ranks"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Plague",
    shortName: "Plague",
    summary: "At turn, sevens are removed from all hands and board.",
    detail: "The announced plague rank is deterministic in this pass: sevens disappear at turn.",
    tags: ["event", "ranks"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Solar Flare",
    shortName: "Flare",
    summary: "At turn, every card's suit is reassigned.",
    detail: "Suits rotate deterministically across hands and board when turn begins.",
    tags: ["event", "suits"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Meteor",
    shortName: "Meteor",
    summary: "At turn, one community card is replaced.",
    detail: "The visible board is struck by a fresh card from the remaining deck.",
    tags: ["event", "board"],
    deal: standardDeal,
  ...
  },
  {
    ...
    shortName: "Mirror U",
    summary: "At river, ranks invert across the game.",
    detail: "Aces become twos, kings become threes, and the mirror continues inward when river begins.",
    tags: ["event", "ranks"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Wildfire",
    shortName: "Wildfire",
    summary: "At river, ranks adjacent to the river card burn away.",
    detail: "Cards one rank above or below the river card are removed from hands and board.",
    tags: ["event", "ranks"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Avalanche",
    shortName: "Avalanche",
    summary: "The board grows from three to five to seven cards.",
    detail: "Avalanche deals seven community cards and reveals 3/5/7 across flop, turn, and river.",
    tags: ["event", "board"],
  ...
  },
  {
    ...
    name: "Storm Surge",
    shortName: "Surge",
    summary: "Every phase, the oldest community card is swept away.",
    detail: "The board drops its oldest card at flop, turn, and river.",
    tags: ["event", "board"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Static",
    shortName: "Static",
    summary: "Every phase, community suits scramble.",
    detail: "Board-card suits rotate at flop, turn, and river while ranks stay fixed.",
    tags: ["event", "suits"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Wormhole",
    shortName: "Wormhole",
    summary: "At river, two hand-pairs swap one hole card.",
    detail: "The first two hands exchange their first hole card when river begins.",
    tags: ["event", "holes"],
    deal: standardDeal,
  ...
  },
  {
    ...
    summary: "At river, one community card vanishes.",
    detail: "The final board card is removed permanently when river begins.",
    tags: ["event", "board"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Gravity Well",
    shortName: "Gravity",
    summary: "At river, each hand's highest hole card upgrades.",
    detail: "The strongest private rank in each hand increases by one when river begins.",
    tags: ["event", "ranks"],
    deal: standardDeal,
  ...
  },
  {
    ...
    summary: "Hole cards carry unresolved alternate identities.",
    detail: "Each private card has a second possible identity until reveal; scoring uses the strongest resolved possibility.",
  ...
  },
  {
    ...
    shortName: "Holo",
    summary: "A community card can present multiple identities.",
    detail: "The board carries possible identities, rendered as uncertain cards until reveal scoring resolves them.",
  ...
  },
  {
    ...
    summary: "Four possible board outcomes are ranked.",
    detail: "Twenty community cards form four five-card boards; each hand scores against its best canonical outcome.",
    tags: ["insanity", "board"],
    deal: {
      ...standardDeal,
      communityCards: 20,
  ...
  },
  {
    ...
    shortName: "Network",
    summary: "Face-down cards share true facts.",
    detail: "The table receives a deterministic true card fact each phase.",
    tags: ["insanity", "info"],
    deal: standardDeal,
  ...
  },
  {
    ...
    tags: ["insanity", "board"],
    deal: { ...standardDeal, visibleCommunityCards: { flop: 3, turn: 10, river: 10, reveal: 10 }, scoreCommunityCards: 5 },
  ...
  },
  {
    ...
    name: "Card Decoy",
    shortName: "Decoy",
    summary: "A fake card sits among the real ones.",
    detail: "Six community cards are shown, but only the first five score.",
    tags: ["insanity", "decoy"],
  ...
  },
  {
    ...
    name: "Card Whisper",
    shortName: "Whisper",
    summary: "At river, one true thing about the board is revealed.",
    detail: "The river broadcast includes a true public fact about a community card.",
    tags: ["insanity", "info"],
    deal: standardDeal,
  ...
  },
  {
    ...
    name: "Mirror Board",
    shortName: "Mirror",
    summary: "At river, the board duplicates itself into ten community cards.",
    detail: "The five-card board mirrors into ten board slots; hands evaluate against the expanded board.",
    tags: ["board", "large"],
    deal: {
      ...standardDeal,
  ...
  },
  {
    ...
    name: "Vault Card",
    shortName: "Vault",
    summary: "A sealed sixth community card opens only at reveal.",
    detail: "Five board cards are playable by river, then a sixth vault card joins the final showdown at reveal.",
  ...
  },
  {
    ...
    name: "Phoenix Board",
    shortName: "Phoenix",
    summary: "Auto-discarded third hole cards return as bonus community cards.",
    detail: "Each hand is dealt three and keeps its strongest two; the discarded cards rise onto the board after the normal five cards.",
    tags: ["deal", "board"],
    deal: {
      holeCards: 3,
      keepCards: 2,
