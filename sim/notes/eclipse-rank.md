...
- Added the `eclipse-rank` mode definition.
- Added `src/modes/eclipse-rank/README.md`.
- Added unit coverage proving board cards expose only ranks until reveal.

## Evidence

- `buildClientState()` masks visible community cards to `{ rank }` for this mode before reveal.
